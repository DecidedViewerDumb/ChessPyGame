...
def select_timer(screen, background, screen_width, screen_height, mode="human_vs_human"):
    ...
    buttons = [
        Button(start_y, "5 minutes", font, (0, 128, 255), (0, 255, 128), (255, 255, 255), screen_width),
        Button(start_y + vertical_spacing, "10 minutes", font, (0, 128, 255), (0, 255, 128), (255, 255, 255), screen_width),
        Button(start_y + vertical_spacing * 2, "15 minutes", font, (0, 128, 255), (0, 255, 128), (255, 255, 255), screen_width),
    ]
